...
CREATE TABLE powerstation (
    powerstation_id SERIAL PRIMARY KEY,
...
CREATE TABLE powerflow_snapshot (
    powerflow_id SERIAL PRIMARY KEY,
    powerstation_id INTEGER REFERENCES powerstation(powerstation_id) ON DELETE CASCADE,
...
CREATE INDEX idx_powerflow_snapshot_station_time ON powerflow_snapshot(powerstation_id, timestamp);
...
CREATE TABLE sem_sync_log (
    id SERIAL PRIMARY KEY,
    powerstation_id INTEGER REFERENCES powerstation(powerstation_id) ON DELETE SET NULL,
